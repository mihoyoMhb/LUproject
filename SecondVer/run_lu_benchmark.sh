...
# Compile the code with optimization flags
gcc -o situ_parallel_naive situ_parallel_naive.c -O3 -march=native -fopenmp -ffast-math -ftree-vectorize -lm
...
# Output file
OUTPUT_FILE="lu_benchmark_results.csv"
